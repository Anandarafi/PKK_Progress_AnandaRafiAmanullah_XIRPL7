      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ url('/event/store') }} " enctype="multimedia/form-data">
            {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  <label>EVENT NAME</label>
                  <input type="text" name="nama_event" class="form-control" placeholder="EVENT NAME" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="info" class="form-control" placeholder="INFO EVENT" required>
                </div>
                <div class="form-group">
                  <label>NUMBER OF TICKETS</label>
                  <input type="text" name="jumlah_tiket" class="form-control" placeholder="NUMBER OF TICKETS" required>
                </div>
                <div class="form-group">
                  <label>PRICE</label>
